...
namespace Pulumi.Iamserviceaccount
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Iamserviceaccount.version.txt");
    ...
    internal sealed class IamserviceaccountResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public IamserviceaccountResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
